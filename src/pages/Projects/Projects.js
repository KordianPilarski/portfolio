  ...
  const projects = [
    {
      ...
      description:
        "An React app where you can arrange to walk a dog. I fetched external API by Axios. In app you can filter dogs list by name, description and weight. You can choose date and lenght of the walk and add it to Your Walks cart.",
      usedTechnologies:
        "React, Hooks, Axios, Context API, React-DateTime-Picker, CSS Modules. ",
      live: "https://the-krd.github.io/Take-A-Dog-For-A-Walk/",
    },
    {
      id: 3,
      name: "Expenses App",
      description:
        "Just another expenses app ;) You can add them, filter by year and see them at the bottom.",
